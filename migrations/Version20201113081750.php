 ...
 */
final class Version20201113081750 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE blog_post RENAME COLUMN blogimage TO blog_image');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE blog_post RENAME COLUMN blog_image TO blogimage');
